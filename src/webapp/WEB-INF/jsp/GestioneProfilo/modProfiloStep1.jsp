...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span12 contentPage">    
			<form:form id="compilatore/modificaProfiloUtenteCompilatoreStep1" modelAttribute="utentiCompilatoriModel" method="post" action="modifica.do">
				...
				<div class="step-pane active" id="step1">
					...
					<fieldset class="form-horizontal">
						...
						<div class="control-group">
							...
							<div class="controls">
									<c:out value="${utentiCompilatoriModel.nome}"></c:out>
						...
						<div class="control-group">
							...
							<div class="controls">
									<c:out value="${utentiCompilatoriModel.cognome}"></c:out>
						...
						<div class="control-group">
							...
							<div class="controls">
									<c:out value="${utentiCompilatoriModel.codiceFiscale}"></c:out>
			...
			<p class="margin-medium">
				...
				<!-- <a class="btn btn-primary pull-right" href="modProfiloStep2.shtml">prosegui</a>-->
			</p>       
