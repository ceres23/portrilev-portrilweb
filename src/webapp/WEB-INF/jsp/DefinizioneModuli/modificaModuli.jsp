...
<div class="row-fluid">
	<div class="span12">
		<ul class="breadcrumb">
			...
			<li class="active">Modifica Modulo</li>
		</ul> 
	</div>	
</div>
...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span12 contentPage">    
			<form:form id="modificaModuli" commandName="moduliModel" method="post" action="">
				...
				<h4 class="step-pane">Dati</h4>
					<fieldset class="form-horizontal">
						...
						<div class="control-group">
							...
							<div class="controls">
								<form:textarea path="descrizione" rows="1" cols="15" class="span8"  maxlength="250" />									
								<form:errors path="descrizione" class="msgErrorRequired" />	
							</div>
						</div>
						
						<div class="control-group">
							<label class="control-label" for="tipo">Tipo Modulo</label>
							<div class="controls">
								<c:out value="${moduliModel.tipo}"></c:out>
						...
						<c:if test="${moduliModel.tipo=='RILEVAZIONE'}" >
						
							<div class="control-group">							
								<label class="control-label" for="rangeCompilazione.dataInizio">Data Inizio Compilazione</label>
								<div class="controls">
										<!-- <form:input path="dataInizioCompilazione" class="span2 datepicker" type="text" />	-->	
										
										<c:choose>  
											<c:when test="${moduliModel.dataCompilabile}"> 
												<form:input path="rangeCompilazione.dataInizio" class="span2 datepicker" type="text" />								
											</c:when>  
											<c:otherwise>  
												<c:out value="${moduliModel.rangeCompilazione.dataInizioStr}"></c:out>
												<form:hidden path="rangeCompilazione.dataInizio" />
											</c:otherwise>  
										</c:choose> 
							...
							<div class="control-group">							
								<label class="control-label" for="rangeCompilazione.dataFine">Data Fine Compilazione</label>
								<div class="controls">
						...
						<div class="control-group">
							...
							<div class="controls">
								<form:textarea path="note" rows="2" cols="15" class="span9" maxlength="4000" />									
								<form:errors path="note" class="msgErrorRequired" />
								<!-- textarea id="noteModulo" rows="2" cols="15" class="span9" type="text" value="" name="noteModulo"></textarea -->
							</div>
						</div>
							  ...
							  <div id="istruzioniCompilatoreTAB" class="accordion-body collapse">
								<div class="accordion-inner">              
									...
									<div class="control-group">
										...
										<form:textarea path="istruzioniCompilazione" rows="8" cols="15" class="span10" maxlength="4000"  />									
...
<script src="../../js/portril/modificaModuli.js" type="text/javascript"></script>
