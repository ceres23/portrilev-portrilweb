...
<div class="row-fluid">
	<div class="span12">
		<ul class="breadcrumb">
			...
			<li class="active">Inserisci Modulo<span class="divider"></span>></li>
			<li class="active">Inserimento Colonne Modulo<span class="divider"></span></li>
		</ul> 
	</div>	
</div>
...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span12 contentPage">    
			<form:form id="gestioneColonneModulo" commandName="gestioneColonneModuloModel" method="post" action="inserisciColonnaModulo.do">
												...
												<h4 class="step-pane">Titolo: <c:out value="${gestioneColonneModuloModel.modulo.nome}" /> </h4>									
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<form:input path="labelColonna" class="span7" type="text" maxlength="50" />									
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<c:set var="posizioneProposta" scope="request" value="${gestioneColonneModuloModel.posizioneProposta}"/>
															<form:input path="posizione" class="span1" type="text" maxlength="2" value="${posizioneProposta}"  />																							
													...
													<%--
													<c:if test="${gestioneColonneModuloModel.modulo.tipo=='RILEVAZIONE'} ">
													<div class="control-group">
													...
													<div id="TipoNumerico" class="TipoNumerico" style="display:none">
														...
														<div class="control-group">
															...
															<div class="controls">
																<form:input path="valoreConfrontoOperatoreNumerico" class="span3" type="text"  />									
													...
													<div id="TipoAlfanumerico" class="TipoAlfanumerico" style="display:none">
														<div class="control-group">
															...
															<div class="controls">
																<form:input path="dimensioneMin" class="span3" type="text" value="0" maxlen="3" />									
														...
														<div class="control-group">
															...
															<div class="controls">
																<form:input path="dimensione" class="span3" type="text" value="100" maxlen="3" />									
													...
													<div id="TipoValoreFisso" class="TipoValoreFisso" style="display:none">
														<div class="control-group">
															...
															<div class="controls">
																...
																<form:errors path="valoreFisso" class="msgErrorRequired" />									
															</div>
														</div>
													</div>
													<!-- /TipoValoreFisso -->
													...
													<p> 
														<!-- <button type="button" id="annulla"  name="annulla"  class="btn btn-primary pull-right" >annulla</button> -->											
			...
			<p class="margin-medium">
				<a href="../menuGestore/start.do" class="btn btn-secondary">torna alla Home</a>
...
<script src="../../js/portril/gestioneColonneModulo.js" type="text/javascript"></script>
