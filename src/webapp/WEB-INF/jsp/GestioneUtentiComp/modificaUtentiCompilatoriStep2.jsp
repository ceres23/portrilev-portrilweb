...
<div class="row-fluid">
	<div class="span12">
		<ul class="breadcrumb">
			...
			<li><a href="../modificaUtentiCompilatoriStep1/goToStep1.do">Modifica Dati</a> <span class="divider">></span></li>	
...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span12 contentPage">    
			<form:form id="gestore/modificaGestioneUtentiCompilatoriStep2" modelAttribute="utentiCompilatoriStep2Model" method="post" action="ricerca.do">
									...
									<fieldset class="form-horizontal">
										<div class="control-group">
											...
											<div class="controls">
												...
												<form:input path="ragioneSociale" class="span9" maxlength="500" type="text"/>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<form:input path="comune" class="span6" maxlength="50" type="text"/>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<form:input path="partitaIva" class="span2" maxlength="11" type="text"/>
											</div>
										</div>
									</fieldset>
									<p>
									<button type="button" class="btn btn-secondary" id ="clean" >pulisci</button> &nbsp;
									<button type="button" class="btn btn-secondary pull-right" name="ricerca" id ="ricerca" >cerca</button> 
									</p>
			...
			<p class="margin-medium">
				<a href="../modificaUtentiCompilatoriStep1/goToStep1.do" class="btn btn-secondary">indietro</a>
...
<script src="../../js/portril/modificaUtentiCompilatoriStep2.js" type="text/javascript"></script>
