...
<body>
	...
	<form:form id="gestore/insGestioneUtentiCompilatoriStep2"
		modelAttribute="utentiCompilatoriStep2Model" method="post"
		action="cercaEnte.do">
		...
		<div class="row-fluid">
			<div class="span12">
				<ul class="breadcrumb">
					...
					<li><a href="../menuGestore/start.do">Home</a> <span
						class="divider">></span></li>
					<li><a
						href="../inserimentoUtentiCompilatoriStep1/goToStep1.do">Inserimento Dati</a> <span class="divider">></span></li>
				...
				<div class="span12 contentPage">
					<form method="get" action="#">
						...
						<div id="MyWizard" class="wizard">
							<ul class="steps">
								<li data-target="#insUtentiComp1"><span
									class="badge badge-success">1</span>Inserimento Dati<span
									class="chevron"></span></li>
								<li data-target="#insUtentiComp2" class="active"><span
									class="badge">2</span>Associa Ente<span class="chevron"></span></li>
							</ul>
						</div>
										...
										<div class="accordion-group">
											<div class="accordion-heading">
												<a class="accordion-toggle collapsed" data-toggle="collapse"
													data-parent="#associaEnti" href="#associaEntiTAB">
													Accreditamento Enti<span class="icon">&nbsp;</span>
												</a>
											</div>
											<div id="associaEntiTAB"
												class="accordion-body collapse <c:out value='${utentiCompilatoriStep2Model.collapse}' />">
												<div class="accordion-inner">
													<fieldset class="form-horizontal">
														<div class="control-group">
															<label class="control-label" for="ragioneSociale">RagioneSociale</label>
															<div class="controls">
																<!-- <input id="RagioneSocialeEnte" class="span9" type="text" value="" name="RagioneSocialeEnte"> -->
																<form:input path="ragioneSociale" class="span9"
...
<%-- 
														<div class="control-group">
															...
															<div class="controls">
																<form:input path="classificazione" class="span6"
...
--%>
														...
														<div class="control-group">
															<label class="control-label" for="codiceFiscale">Codice
																Fiscale</label>
															<div class="controls">
																<!-- <input id="CodiceFiscaleEnte" class="span6" type="text" value="" name="CodiceFiscaleEnte"> -->
																<form:input path="codiceFiscale" class="span6"
																	maxlength="16" type="text" />
															</div>
														</div>

														<div class="control-group">
															<label class="control-label" for="partitaIva">Partita
																Iva</label>
															<div class="controls">
																<!-- <input id="PartitaIvaEnte" class="span6" type="text" value="" name="PartitaIvaEnte"> -->
																<form:input path="partitaIva" class="span2"
													...
													<div id="TableEnti"
														class="collapse <c:out value='${utentiCompilatoriStep2Model.collapse}' /> ">
														<div>
															<fieldset class="form-horizontal">
						...
						<p class="margin-medium">
							<a href="../inserimentoUtentiCompilatoriStep1/goToStep1.do" class="btn btn-secondary">indietro</a>
		...
		<script src="../../js/portril/utentiCompilatori.js"
