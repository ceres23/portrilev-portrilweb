...
<c:when test="${empty utentiCompilatoriStep2Model.listaEntiAssociati}"> 
	<!-- eventuale condizione di successo -->
       ...
       <c:otherwise>  
		...
		<table class="table table-hover tab_left dataTable" summary="...." id="tabellaEntiAssociati">
			<thead>
				<tr>
			...
			<tbody>
				...
				<tr>
					...
					<td class="tab_Right">
						<button type="button" class="btn btn-secondary pulsanteDisassocia" data-uid="<c:out value='${enteAssociato.idEnteCompilatore}' />">Dissocia</button>				
					</td>
				</tr>
				</c:forEach>
			</tbody>
