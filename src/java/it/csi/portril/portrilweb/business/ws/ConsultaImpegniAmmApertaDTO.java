...
/**
 * <p>Classe Java per consultaImpegniAmmApertaDTO complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="consultaImpegniAmmApertaDTO">
 *   &lt;complexContent>
 ...
 *         &lt;element name="impegniAmmAperta" type="{http://cxf.bilancio.interfacecxf.cmpsrvrp.bilsrvrp.csi.it/}impegnoAmmAperta" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "consultaImpegniAmmApertaDTO", propOrder = {
    "anno",
    "impegniAmmAperta",
    "pageIndex",
    "pageSize",
...
public class ConsultaImpegniAmmApertaDTO
    extends BaseDTO
{

    protected String anno;
    @XmlElement(nillable = true)
    protected List<ImpegnoAmmAperta> impegniAmmAperta;
    ...
    /**
     * Gets the value of the impegniAmmAperta property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the impegniAmmAperta property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getImpegniAmmAperta().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ImpegnoAmmAperta }
     * 
     * 
     */
    public List<ImpegnoAmmAperta> getImpegniAmmAperta() {
        if (impegniAmmAperta == null) {
            impegniAmmAperta = new ArrayList<ImpegnoAmmAperta>();
        }
        return this.impegniAmmAperta;
    }
